...
const allPeptides: PeptideData[] = [
  ...
  { name: "GHK-Cu", category: "Skin Research", description: "Copper-binding tripeptide investigated in skin and extracellular matrix research.", icon: "Atom", color: "from-[#4FC3F7] to-[#7B2CBF]", refs: [{ label: "Pickart et al., Biomed Res Int, 2015", url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4566513/" }], section: "Peptides" },
  ...
  { name: "CJC-1295 (no DAC)", category: "Growth Hormone", description: "GHRH-analogue design investigated for endocrine signaling and pharmacology; 'no DAC' refers to absence of a drug-affinity complex modification.", icon: "TrendingUp", color: "from-[#7B2CBF] to-[#E91E8C]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=CJC-1295+no+DAC+GHRH" }], section: "Peptides" },
  { name: "CJC-1295 DAC", category: "Growth Hormone", description: "'DAC' refers to a modification intended to alter pharmacokinetics; literature is primarily pharmacology/endocrinology.", icon: "TrendingUp", color: "from-[#00ACC1] to-[#4FC3F7]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=CJC-1295+DAC" }], section: "Peptides" },
  ...
  { name: "Humanin", category: "Mitochondrial", description: "Humanin is studied as a mitochondrial-derived peptide with roles in cellular stress response models.", icon: "Dna", color: "from-[#4FC3F7] to-[#7B2CBF]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=humanin+mitochondrial+derived+peptide" }], section: "Peptides" },
  ...
  { name: "MOTS-C", category: "Mitochondrial", description: "Studied in metabolic adaptation and stress-response signaling (preclinical + emerging human literature).", icon: "Dna", color: "from-[#00ACC1] to-[#4FC3F7]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=MOTS-C" }], section: "Peptides" },
  { name: "LL-37", category: "Immune", description: "Endogenous antimicrobial peptide (cathelicidin) studied in innate immune signaling and host defense biology.", icon: "Shield", color: "from-[#E91E8C] to-[#7B2CBF]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=LL-37+cathelicidin" }], section: "Peptides" },
  ...
  { name: "FOXO4-DRI", category: "Aging Research", description: "Designed to probe FOXO4-p53 interaction pathways in senescence models.", icon: "Microscope", color: "from-[#7B2CBF] to-[#4FC3F7]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=FOXO4-DRI" }], section: "Peptides" },
  { name: "Gonadorelin", category: "Hormone", description: "Synthetic GnRH used as a research/clinical reference compound in endocrine signaling literature.", icon: "Activity", color: "from-[#00ACC1] to-[#7B2CBF]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=gonadorelin+GnRH" }], section: "Peptides" },
  ...
  { name: "PT-141 (Bremelanotide)", category: "Melanocortin", description: "Studied in controlled clinical settings for melanocortin receptor pathway pharmacology.", icon: "Sun", color: "from-[#7B2CBF] to-[#9C27B0]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=bremelanotide+PT-141" }], section: "Peptides" },
  { name: "Oxytocin", category: "Neuropeptide", description: "Cyclic nonapeptide studied in neuroendocrine signaling; outcomes in behavioral studies vary by design and population.", icon: "Brain", color: "from-[#E91E8C] to-[#C2185B]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=oxytocin+intranasal+clinical+trial" }], section: "Peptides" },
  ...
  { name: "Liraglutide", category: "Therapeutic", description: "GLP-1 receptor agonist studied in clinical settings.", icon: "Zap", color: "from-[#E91E8C] to-[#7B2CBF]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=liraglutide+trial" }], section: "Therapeutics" },
  { name: "Dulaglutide", category: "Therapeutic", description: "GLP-1 receptor agonist studied in clinical trials.", icon: "Zap", color: "from-[#4FC3F7] to-[#E91E8C]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=dulaglutide+trial" }], section: "Therapeutics" },
  ...
  { name: "Retatrutide", category: "Therapeutic", description: "Multi-receptor agonist; investigational peptide therapeutic.", icon: "Zap", color: "from-[#00ACC1] to-[#7B2CBF]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=retatrutide+trial" }], section: "Therapeutics" },
  ...
  { name: "Setmelanotide", category: "Therapeutic", description: "MC4R agonist studied in regulated drug context.", icon: "Zap", color: "from-[#E91E8C] to-[#C2185B]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=setmelanotide+trial" }], section: "Therapeutics" },

  // ── Melanocortin pathway ──
  { name: "Melanotan II", category: "Melanocortin", description: "Melanocortin receptor agonist; discussed in pharmacology and safety literature. Product identity/quality is a frequent concern outside regulated systems.", icon: "Sun", color: "from-[#4FC3F7] to-[#7B2CBF]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=melanotan+II" }], section: "Peptides" },
  { name: "Melanotan-I (Afamelanotide)", category: "Melanocortin", description: "Melanocortin pathway peptide therapeutic; regulated drug context in some jurisdictions.", icon: "Sun", color: "from-[#7B2CBF] to-[#E91E8C]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=afamelanotide" }], section: "Peptides" },
  ...
  { name: "IGF-1 LR3", category: "Protein/Biologic", description: "Protein/peptide growth factor analogue studied in research.", icon: "TrendingUp", color: "from-[#E91E8C] to-[#7B2CBF]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=IGF-1+LR3" }], section: "Proteins" },
  { name: "HMG (Human Menopausal Gonadotropin)", category: "Protein/Biologic", description: "Biologic hormone preparation with FSH/LH activity.", icon: "Activity", color: "from-[#4FC3F7] to-[#E91E8C]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=human+menopausal+gonadotropin+hMG" }], section: "Proteins" },
  { name: "HCG", category: "Protein/Biologic", description: "Glycoprotein hormone (biologic) studied in endocrine research.", icon: "Activity", color: "from-[#7B2CBF] to-[#4FC3F7]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=human+chorionic+gonadotropin+hCG" }], section: "Proteins" },
  ...
  // ── Small Molecules ──
  { name: "Dihexa", category: "Small Molecule", description: "AngIV-related small molecule discussed in HGF/c-Met pathway research; literature includes concerns about retractions/quality.", icon: "Beaker", color: "from-[#E91E8C] to-[#C2185B]", refs: [{ label: "PubMed Entry", url: "https://pubmed.ncbi.nlm.nih.gov/25649658/" }, { label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=Dihexa" }], section: "Small Molecules" },
  { name: "SLU-PP-332", category: "Small Molecule", description: "ERR agonist; small molecule studied in metabolic research.", icon: "Beaker", color: "from-[#4FC3F7] to-[#7B2CBF]", refs: [{ label: "PubMed Entry", url: "https://pubmed.ncbi.nlm.nih.gov/37739806/" }, { label: "Full Text (PMC)", url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC10801787/" }], section: "Small Molecules" },
  { name: "5-Amino-1MQ", category: "Small Molecule", description: "NNMT inhibitor; small molecule studied in metabolic contexts.", icon: "Beaker", color: "from-[#7B2CBF] to-[#E91E8C]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=5-Amino-1MQ+NNMT" }], section: "Small Molecules" },
  { name: "MK-677 (Ibutamoren)", category: "Small Molecule", description: "Ghrelin mimetic; small molecule studied in growth hormone secretagogue research.", icon: "Beaker", color: "from-[#00ACC1] to-[#4FC3F7]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=ibutamoren+MK-677" }], section: "Small Molecules" },
  { name: "Tesofensine", category: "Small Molecule", description: "Small molecule studied in metabolic research.", icon: "Beaker", color: "from-[#E91E8C] to-[#7B2CBF]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=tesofensine" }], section: "Small Molecules" },
  { name: "Methylene Blue", category: "Small Molecule", description: "Small molecule studied in mitochondrial function research.", icon: "Beaker", color: "from-[#4FC3F7] to-[#E91E8C]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=methylene+blue+mitochondria" }], section: "Small Molecules" },

  // ── Other Peptides / Fragments ──
  { name: "AOD-9604", category: "Fragment", description: "HGH fragment 176-191 derivative studied in metabolic research.", icon: "Atom", color: "from-[#7B2CBF] to-[#4FC3F7]", refs: [{ label: "PubMed Entry", url: "https://pubmed.ncbi.nlm.nih.gov/11713213/" }, { label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=AOD-9604" }], section: "Peptides" },
  { name: "HGH Fragment 176-191", category: "Fragment", description: "Peptide fragment studied in metabolic research.", icon: "Atom", color: "from-[#00ACC1] to-[#7B2CBF]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=HGH+fragment+176-191" }], section: "Peptides" },
  ...
  { name: "NAD+", category: "Coenzyme", description: "Central redox/metabolic cofactor in energy metabolism literature; clinical outcomes depend on context and are often studied via precursors.", icon: "Atom", color: "from-[#7B2CBF] to-[#4FC3F7]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=NAD%2B+metabolism+human" }], section: "Coenzymes" },
  { name: "L-Carnitine", category: "Coenzyme", description: "Amino acid derivative studied in metabolic research.", icon: "Atom", color: "from-[#00ACC1] to-[#7B2CBF]", refs: [{ label: "PubMed Search", url: "https://pubmed.ncbi.nlm.nih.gov/?term=L-carnitine+metabolism" }], section: "Coenzymes" },
