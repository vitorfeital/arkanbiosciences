    ...
    <footer className="relative border-t border-white/10 bg-[#0A0A0A]">
      <div className="container py-16">
        ...
        <div className="mt-8 pt-6 border-t border-white/5 flex flex-col items-center gap-3">
          <a href="https://tru-co.com/" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-3 hover:opacity-100 transition-opacity">
            <img
              src="/images/tru-co-logo.webp"
              alt="TRU & CO."
              className="h-8 w-auto opacity-70 hover:opacity-100 transition-opacity"
            />
            <p className="text-gray-500 text-xs text-center hover:text-gray-400 transition-colors">
